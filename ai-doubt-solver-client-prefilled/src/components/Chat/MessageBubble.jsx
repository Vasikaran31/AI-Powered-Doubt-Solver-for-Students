...
// ── Sub-component: renders AI markdown with code highlighting ─
...
export default function MessageBubble({ message }) {
  ...
  // - Write message.content to the clipboard using navigator.clipboard.writeText
  // - Set copied to true and show a toast 'Copied!'
  // - After 2 seconds, reset copied back to false
  const copyContent = () => {
