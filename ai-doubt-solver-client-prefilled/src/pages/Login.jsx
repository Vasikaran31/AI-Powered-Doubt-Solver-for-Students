...
export default function Login() {
  ...
  // - Validate that email and password are not empty; toast an error if they are
  // - Set loading true
  // - Call login(form.email, form.password) from AuthContext
  // - On success: toast 'Welcome back!' and navigate to '/dashboard'
  // - On error: toast the error message from err.response?.data?.message
  //   or fall back to 'Login failed. Please try again.'
